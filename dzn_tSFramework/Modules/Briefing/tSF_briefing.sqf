...
TOPIC("VI. Замечания:")
"1. КВ Рации есть только у СЛ-а и ФТЛ, Пользуйтесь свистками при необходимости<br />2. Река на нашем правом фланге считается непроходимой!<br />3. Зона, отмеченная красной штриховкой, недоступна для операции."
END
